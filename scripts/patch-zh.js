...
function patchMainMenu() {
  ...
  const replacements = [
    ...
    ["label:`About ${U.app.getName()}`", "label:`关于 ${U.app.getName()}`"],
    ["title:\"About Codex\"", "title:\"关于 Codex\""],
    ["detail:`Version ${U.app.getVersion()}\n© OpenAI`", "detail:`版本 ${U.app.getVersion()}\n© OpenAI`"],
    ...
    ["detail:`Sparkle initialization skipped: ${Te}`", "detail:`已跳过 Sparkle 初始化：${Te}`"],
    ["label:\"View\"", "label:\"视图\""],
